...
namespace Ordering.Data.Migrations
{
    ...
    [Migration("20250725235703_UpdateOrder")]
            ...
            modelBuilder.Entity("Ordering.Orders.Models.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BillingsAddress", "Ordering.Orders.Models.Order.BillingsAddress#Address", b1 =>
                        {
                            b1.IsRequired();
